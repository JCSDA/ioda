...
public ioda_obs_radiance
public ioda_obs_radiance_setup, ioda_obs_radiance_delete
public ioda_obs_radiance_read, ioda_obs_radiance_generate
public ioda_obs_radiance_getlocs

! ------------------------------------------------------------------------------

!> Fortran derived type to hold observation locations
type :: ioda_obs_radiance
  integer :: nobs
  integer :: nlocs
...
subroutine ioda_obs_radiance_setup(self, nobs)
implicit none
type(ioda_obs_radiance), intent(inout) :: self
...
end subroutine ioda_obs_radiance_setup

! ------------------------------------------------------------------------------

subroutine ioda_obs_radiance_delete(self)
implicit none
type(ioda_obs_radiance), intent(inout) :: self
...
end subroutine ioda_obs_radiance_delete

! ------------------------------------------------------------------------------

subroutine ioda_obs_radiance_generate(self, nobs, lat, lon1, lon2)
implicit none
type(ioda_obs_radiance), intent(inout) :: self
integer, intent(in) :: nobs
...
call ioda_obs_radiance_setup(self, nobs)
...
end subroutine ioda_obs_radiance_generate

! ------------------------------------------------------------------------------

subroutine ioda_obs_radiance_read(filename, self)
...
end subroutine ioda_obs_radiance_read

! ------------------------------------------------------------------------------

subroutine ioda_obs_radiance_getlocs(self, locs)
use ioda_locs_mod
implicit none
type(ioda_obs_radiance), intent(in) :: self
...
end subroutine ioda_obs_radiance_getlocs

! ------------------------------------------------------------------------------

end module ioda_obs_radiance_mod
