...
// -----------------------------------------------------------------------------
/*!
 * \details Config based constructor for an ObsSpaceView object. This constructor will read
 ...
 */
ObsSpaceView::ObsSpaceView(const eckit::Configuration & config,
                   const util::DateTime & bgn, const util::DateTime & end)
  : oops::ObsSpaceBase(config, bgn, end),
    obsspace_ (new ObsSpace(config, bgn, end))
 ...
 *          ObsSpace object.
 */
ObsSpaceView::~ObsSpaceView() {
}

void ObsSpaceView::get_db(const std::string & group, const std::string & name,
...
void ObsSpaceView::put_db(const std::string & group, const std::string & name,
...
bool ObsSpaceView::has(const std::string & group, const std::string & name) const {
 ...
 */
std::size_t ObsSpaceView::gnlocs() const {
 ...
 *          multiple process elements.
 */
std::size_t ObsSpaceView::nlocs() const {
 ...
 */
std::size_t ObsSpaceView::nrecs() const {
 ...
 */
std::size_t ObsSpaceView::nvars() const {
 ...
 */
const std::vector<std::size_t> & ObsSpaceView::recnum() const {
 ...
 *          data member. This is for read only access.
 */
const std::vector<std::size_t> & ObsSpaceView::index() const {
 ...
 *          recidx_ data member.
 */
const ObsSpaceView::RecIdxIter ObsSpaceView::recidx_begin() const {
 ...
 *          recidx_ data member.
 */
const ObsSpaceView::RecIdxIter ObsSpaceView::recidx_end() const {
 ...
 */
bool ObsSpaceView::recidx_has(const std::size_t RecNum) const {
 ...
 */
std::size_t ObsSpaceView::recidx_recnum(const RecIdxIter & Irec) const {
 ...
 *          given iterator, from the recidx_ data member.
 */
const std::vector<std::size_t> & ObsSpaceView::recidx_vector(const RecIdxIter & Irec) const {
 ...
 *          given iterator, from the recidx_ data member.
 */
const std::vector<std::size_t> & ObsSpaceView::recidx_vector(const std::size_t RecNum) const {
 ...
 */
std::vector<std::size_t> ObsSpaceView::recidx_all_recnums() const {
 ...
 */
void ObsSpaceView::generateDistribution(const eckit::Configuration & conf) {
 ...
 */
void ObsSpaceView::printJo(const ObsVector & dy, const ObsVector & grad) {
