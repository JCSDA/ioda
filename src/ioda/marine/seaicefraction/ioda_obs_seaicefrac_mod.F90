...
module ioda_obs_seaicefrac_mod
...
subroutine ioda_obs_seaicefrac_setup(self, nobs)
implicit none
...
end subroutine ioda_obs_seaicefrac_setup

! ------------------------------------------------------------------------------

subroutine ioda_obs_seaicefrac_delete(self)
implicit none
type(ioda_obs_seaicefrac), intent(inout) :: self
...
end subroutine ioda_obs_seaicefrac_delete

! ------------------------------------------------------------------------------

subroutine ioda_obs_seaicefrac_generate(self, nobs, lat, lon1, lon2)
implicit none
type(ioda_obs_seaicefrac), intent(inout) :: self
integer, intent(in) :: nobs
...
call ioda_obs_seaicefrac_setup(self, nobs)
...
end subroutine ioda_obs_seaicefrac_generate
...
subroutine ioda_obs_seaicefrac_getlocs(self, locs)
use ioda_locs_mod
implicit none
