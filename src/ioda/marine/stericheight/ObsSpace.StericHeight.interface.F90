...
subroutine ioda_obsdb_stericheight_get_c(c_key_self, c_tname, c_tname_size, c_tdata, c_tdata_size) bind(c,name='ioda_obsdb_stericheight_get_f90')  
implicit none
integer(c_int), intent(in) :: c_key_self
...
subroutine ioda_obsdb_stericheight_getvar_c(c_key_self, lcol, c_col, vdata, vsize) bind(c,name='ioda_obsdb_stericheight_getvar_f90')  
implicit none
integer(c_int), intent(in) :: c_key_self
...
call ioda_obs_stericheight_registry%get(c_key_self, self)
call ioda_obs_stericheight_copy_var(self, vname, vdata, vsize)

end subroutine ioda_obsdb_stericheight_getvar_c
