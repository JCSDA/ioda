...
elseif(DEFINED ENV{CDASH_OVERRIDE_SITE})
		set(SITE "$ENV{CDASH_OVERRIDE_SITE}" CACHE STRING "Site name (use CDASH_OVERRIDE_SITE to customize)" FORCE)
else()
...
set(TESTING_COMPILER "${TESTING_CXX_COMPILER_ID};hdf5_${HDF5_VERSION}")
