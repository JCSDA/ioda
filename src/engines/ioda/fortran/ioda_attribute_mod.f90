...
contains
   ...
   subroutine ioda_attribute_get_dimensions(this, dims)
      implicit none
      class(ioda_attribute) :: this
      type(ioda_dimensions) :: dims
      if (.not. c_associated(dims%data_ptr)) then
         call ioda_dimensions_init(dims)
      end if
   ...
   logical function ioda_attribute_write_str(this, data_) result(r)
      implicit none
      class(ioda_attribute) :: this
      class(ioda_vecstring), intent(in):: data_
   ...
   logical function ioda_attribute_read_str(this, data_) result(r)
      implicit none
      class(ioda_attribute) :: this
      class(ioda_vecstring), intent(out) :: data_
