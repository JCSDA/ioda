module cxx_vector_string_mod
    ...
    use :: f_c_string_mod, only: &
        c_free, c_string_to_f_copy, f_string_to_c_dup
    use :: cxx_string_mod, only: cxx_string
    implicit none
    private
    public :: &
        cxx_vector_string_c_alloc, cxx_vector_string_c_clear, &
        cxx_vector_string_c_copy, cxx_vector_string_c_element_size, &
        cxx_vector_string_c_empty, cxx_vector_string_c_get, &
        cxx_vector_string_c_get_str, cxx_vector_string_c_push_back, &
        cxx_vector_string_c_push_back_str, cxx_vector_string_c_resize, &
        cxx_vector_string_c_set, cxx_vector_string_c_set, &
        cxx_vector_string_c_size, cxx_vector_string_init

    type, public :: cxx_vector_string
    ...
    interface
        ...
        subroutine cxx_vector_string_c_set(p,i,v) bind(C,name="cxx_vector_string_c_set")
            ...
            type(c_ptr),value :: v
        end subroutine cxx_vector_string_c_set
        subroutine cxx_vector_string_c_set_str(p,i,v) bind(C,name="cxx_vector_string_c_set_str")
            ...
            integer(c_int64_t),value :: i
            type(c_ptr),value :: v
        end subroutine cxx_vector_string_c_set_str
        function cxx_vector_string_c_get(p,i) result(r) bind(C,name="cxx_vector_string_c_get")
            ...
            integer(c_int64_t),value :: i
            type(c_ptr) :: r
        end function cxx_vector_string_c_get
...
contains
    ...
    end subroutine cxx_vector_string_init
    ...
    end subroutine cxx_vector_string_dealloc
    ...
    end subroutine cxx_vector_string_copy
    ...
    end subroutine cxx_vector_string_set_str
    ...
    end subroutine cxx_vector_string_set
    ...
    end subroutine cxx_vector_string_push_back_str
    ...
    end subroutine cxx_vector_string_resize
    ...
    end function cxx_vector_string_associated
    ...
    end function cxx_vector_string_empty
end module cxx_vector_string_mod
