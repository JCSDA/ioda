...
module ioda_variable_mod
    use,intrinsic :: iso_c_binding, only: &
      c_bool, c_double, c_float, c_int16_t, c_int32_t, c_int64_t, c_null_ptr, c_ptr
    ...
    use :: f_c_string_mod, only: &
        c_alloc, c_free, c_string_to_f_copy, f_string_to_c_dup
    implicit none
    private
    public :: ioda_variable_init

    type, public :: ioda_variable
...
interface
    ...
    end subroutine ioda_variable_c_clone
    ...
    function ioda_variable_c_has_attributes(p) result(has_att) bind(C,name="ioda_variable_c_has_attributes")
        ...
        type(c_ptr),value :: p
        type(c_ptr) :: has_att
    end function ioda_variable_c_has_attributes
    ...
    function ioda_variable_c_get_dimensions(p) result(dims_ptr) bind(C,name="ioda_variable_c_get_dimensions")
        ...
        type(c_ptr), value :: p
        type(c_ptr) :: dims_ptr
    end function ioda_variable_c_get_dimensions
    ...
    function ioda_variable_c_resize(p,n,dims) result(r) bind(C,name="ioda_variable_c_resize")
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_resize
    ...
    function ioda_variable_c_attach_dim_scale(p,dim_n,var_ptr) result(r) &
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_attach_dim_scale
    ...
    function ioda_variable_c_detach_dim_scale(p,dim_n,var_ptr) result(r) &
        ...
        integer(c_int32_t), value :: dim_n
        logical(c_bool) :: r
    end function ioda_variable_c_detach_dim_scale
    ...
    function ioda_variable_c_set_dim_scale(p,n,var_ptr) result(r) &
        ...
        logical(c_bool) ::  r
    end function ioda_variable_c_set_dim_scale
    ...
    function ioda_variable_c_is_dim_scale(p) result(r) &
        ...
        type(c_ptr), value :: p
        logical(c_bool) :: r
    end function ioda_variable_c_is_dim_scale
    ...
    function ioda_variable_c_set_is_dim_scale(p,sz,dims_name) result(r) &
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_set_is_dim_scale
    ...
    function ioda_variable_c_get_dim_scale_name(p,n,out_str) result(r) &
        ...
        type(c_ptr), value :: p
        integer(c_int64_t), value :: n
        type(c_ptr), intent(inout) :: out_str
        integer(c_int64_t) :: r
    end function ioda_variable_c_get_dim_scale_name
    ...
    function ioda_variable_c_is_dim_scale_attached(p,dim_n,var_ptr) result(r) &
        ...
        integer(c_int32_t), value :: dim_n
        integer(C_int32_t) :: r
    end function ioda_variable_c_is_dim_scale_attached
    ...
    function ioda_variable_c_is_a_float(p) result(r) bind(C,name="ioda_variable_c_is_a_float")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_float
    ...
    function ioda_variable_c_is_a_double(p) result(r) bind(C,name="ioda_variable_c_is_a_double")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_double
    ...
    function ioda_variable_c_is_a_ldouble(p) result(r) bind(C,name="ioda_variable_c_is_a_ldouble")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_ldouble
    ...
    function ioda_variable_c_is_a_char(p) result(r) bind(C,name="ioda_variable_c_is_a_char")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_char
    ...
    function ioda_variable_c_is_a_int16(p) result(r) bind(C,name="ioda_variable_c_is_a_int16")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_int16
    ...
    function ioda_variable_c_is_a_int32(p) result(r) bind(C,name="ioda_variable_c_is_a_int32")
        ...
        type(c_ptr),value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_int32
    ...
    function ioda_variable_c_is_a_int64(p) result(r) bind(C,name="ioda_variable_c_is_a_int64")
        ...
        type(c_ptr),value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_int64
    ...
    function ioda_variable_c_is_a_uint16(p) result(r) bind(C,name="ioda_variable_c_is_a_uint16")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_uint16
    ...
    function ioda_variable_c_is_a_uint32(p) result(r) bind(C,name="ioda_variable_c_is_a_uint32")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_uint32
    ...
    function ioda_variable_c_is_a_uint64(p) result(r) bind(C,name="ioda_variable_c_is_a_uint64")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_uint64
    ...
    function ioda_variable_c_is_a_str(p) result(r) bind(C,name="ioda_variable_c_is_a_str")
        ...
        type(c_ptr), value :: p
        integer(c_int32_t) :: r
    end function ioda_variable_c_is_a_str
    ...
    function ioda_variable_c_write_float(p,n,data_) result(r) bind(C,name="ioda_variable_c_write_float")
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_write_float
    ...
    function ioda_variable_c_write_double(p,n,data_) result(r) bind(C,name="ioda_variable_c_write_double")
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_write_double
    ...
    function ioda_variable_c_write_char(p,n,data_) result(r) bind(C,name="ioda_variable_c_write_char")
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_write_char
    ...
    function ioda_variable_c_write_int16(p,n,data_) result(r) bind(C,name="ioda_variable_c_write_int16")
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_write_int16
    ...
    function ioda_variable_c_write_int32(p,n,data_) result(r) bind(C,name="ioda_variable_c_write_int32")
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_write_int32
    ...
    function ioda_variable_c_write_int64(p,n,data_) result(r) bind(C,name="ioda_variable_c_write_int64")
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_write_int64
    ...
    function ioda_variable_c_write_str(p,vstr) result(r) bind(C,name="ioda_variable_c_write_str")
        ...
        logical(c_bool) :: r
    end function ioda_variable_c_write_str
    ...
    function ioda_variable_c_read_float(p,n,data_) result(r) bind(C,name="ioda_variable_c_read_float")
        ...
        real(c_float),dimension(*),intent(out) :: data_
        logical(c_bool) :: r
    end function ioda_variable_c_read_float
    ...
    function ioda_variable_c_read_double(p,n,data_) result(r) bind(C,name="ioda_variable_c_read_double")
        ...
        real(c_double),dimension(*),intent(out) :: data_
        logical(c_bool) :: r
    end function ioda_variable_c_read_double
    ...
    function ioda_variable_c_read_char(p,n,data_) result(r) bind(C,name="ioda_variable_c_read_char")
        ...
        type(c_ptr), value :: p
        integer(c_int64_t), value :: n
        type(c_ptr), intent(inout) :: data_
        logical(c_bool) :: r
    end function ioda_variable_c_read_char
    ...
    function ioda_variable_c_read_int16(p,n,data_) result(r) bind(C,name="ioda_variable_c_read_int16")
        ...
        integer(c_int16_t),dimension(*),intent(out) :: data_
        logical(c_bool) :: r
    end function ioda_variable_c_read_int16
    ...
    function ioda_variable_c_read_int32(p,n,data_) result(r) bind(C,name="ioda_variable_c_read_int32")
        ...
        integer(c_int32_t),dimension(*),intent(out) :: data_
        logical(c_bool) :: r
    end function ioda_variable_c_read_int32
    ...
    function ioda_variable_c_read_int64(p,n,data_) result(r) bind(C,name="ioda_variable_c_read_int64")
        ...
        integer(c_int64_t),dimension(*),intent(out) :: data_
        logical(c_bool) :: r
    end function ioda_variable_c_read_int64

    function ioda_variable_c_read_str(p,vstr) result(r) bind(C,name="ioda_variable_c_read_str")
        import c_ptr,c_bool
        implicit none
        type(c_ptr), value :: p
        type(c_ptr), intent(inout) :: vstr
        logical(c_bool) :: r
    end function ioda_variable_c_read_str
...
contains
    ...
    subroutine ioda_variable_init(this)
       implicit none
       type(ioda_variable), intent(inout) :: this
       this%data_ptr = c_null_ptr
    end subroutine ioda_variable_init

    subroutine ioda_variable_dtor(this)
       implicit none
       type(ioda_variable), intent(inout) :: this
!       call ioda_variable_c_dtor(this%data_ptr)
    end subroutine ioda_variable_dtor
    ...
    end function ioda_variable_attach_dim_scale
    ...
    end function ioda_variable_detach_dim_scale
    ...
    end function ioda_variable_set_is_dim_scale
    ...
    integer(int64) function ioda_variable_get_dim_scale_name(this,sz,name) result(r)
       ...
       call c_free(name_ptr)
    end function ioda_variable_get_dim_scale_name
    ...
    end function ioda_variable_is_a_double
    ...
    end function ioda_variable_is_a_ldouble
    ...
    end function ioda_variable_is_a_char
    ...
    end function ioda_variable_is_a_int16
    ...
    function ioda_variable_is_a_int32(this) result(r)
        ...
        integer(int32) :: r
        r = ioda_variable_c_is_a_int32(this%data_ptr)
    end function ioda_variable_is_a_int32
    ...
    end function ioda_variable_is_a_int64
    ...
    end function ioda_variable_is_a_str
    ...
    end function ioda_variable_is_a_uint16
    ...
    function ioda_variable_is_a_uint32(this) result(r)
        ...
        integer(int32) :: r
        r = ioda_variable_c_is_a_uint32(this%data_ptr)
    end function ioda_variable_is_a_uint32
    ...
    end function ioda_variable_is_a_uint64
    ...
    end function ioda_variable_write_float
    ...
    end function ioda_variable_write_double
    ...
    end function ioda_variable_write_int16
    ...
    end function ioda_variable_write_int32
    ...
    end function ioda_variable_write_int64
    ...
    function ioda_variable_write_char(this,n,data_) result(r)
        ...
        call c_free(data_p)
    end function ioda_variable_write_char
    ...
    end function ioda_variable_write_str
    ...
    end function ioda_variable_read_float
    ...
    end function ioda_variable_read_double
    ...
    end function ioda_variable_read_int16
    ...
    end function ioda_variable_read_int32
    ...
    end function ioda_variable_read_int64
    ...
    function ioda_variable_read_char(this,n,data_) result(r)
        ...
        call c_free(data_p)
    end function ioda_variable_read_char
    ...
    end function ioda_variable_read_str

end module ioda_variable_mod
