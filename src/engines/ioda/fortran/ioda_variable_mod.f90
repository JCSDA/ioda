...
contains
   ...
   subroutine ioda_variable_init(this)
      ...
      this%data_ptr = ioda_variable_c_alloc()
   end subroutine
   ...
   subroutine ioda_variable_has_attributes(this, atts)
      implicit none
      class(ioda_variable) :: this
      class(ioda_has_attributes) :: atts
      if (c_associated(atts%data_ptr)) then
         call ioda_has_attributes_dtor(atts)
      end if
      atts%data_ptr = ioda_variable_c_has_attributes(this%data_ptr)
   end subroutine

   subroutine ioda_variable_get_dimensions(this, dims)
      implicit none
      class(ioda_variable) :: this
      class(ioda_dimensions) :: dims
      if (c_associated(dims%data_ptr)) then
         call ioda_dimensions_dtor(dims)
      end if
