...
#define IODA_HAS_ATTRIBUTES_INST_TEMPLATE(shortnamestr, basenamestr) \
  res.Has_Attributes.shortnamestr = basenamestr;
    ...
    C_TEMPLATE_FUNCTION_DECLARATION_3(create, ioda_has_attributes_create, IODA_HAS_ATTRIBUTES_INST_TEMPLATE);
...
#define IODA_VCP_INST_TEMPLATE(shortnamestr, basenamestr) \
  res.VariableCreationParams.shortnamestr = basenamestr;
    ...
    C_TEMPLATE_FUNCTION_DECLARATION_3_NOSTR(setFillValue, ioda_variable_creation_parameters_setFillValue,
    ...
    res.VariableCreationParams.compressWithGZIP = &ioda_variable_creation_parameters_compressWithGZIP;
    res.VariableCreationParams.compressWithSZIP = &ioda_variable_creation_parameters_compressWithSZIP;
    res.VariableCreationParams.hasSetDimScales = &ioda_variable_creation_parameters_hasSetDimScales;
    res.VariableCreationParams.attachDimensionScale = &ioda_variable_creation_parameters_attachDimensionScale;
    res.VariableCreationParams.setDimScale = &ioda_variable_creation_parameters_setDimScale;
    res.VariableCreationParams.isDimensionScale = &ioda_variable_creation_parameters_isDimensionScale;
    res.VariableCreationParams.setIsDimensionScale = &ioda_variable_creation_parameters_setIsDimensionScale;
...
#define IODA_VARIABLE_INST_TEMPLATE(shortnamestr, basenamestr) res.Variable.shortnamestr = basenamestr;
    ...
    // res.Variable.read_*
    C_TEMPLATE_FUNCTION_DECLARATION_3(read_full, ioda_variable_read_full, IODA_VARIABLE_INST_TEMPLATE);

    // res.Variable.write_*
    C_TEMPLATE_FUNCTION_DECLARATION_3(write_full, ioda_variable_write_full, IODA_VARIABLE_INST_TEMPLATE);
...
#define IODA_HAS_VARIABLES_INST_TEMPLATE(shortnamestr, basenamestr) \
  res.Has_Variables.shortnamestr = basenamestr;
    ...
    C_TEMPLATE_FUNCTION_DECLARATION_3(create, ioda_has_variables_create, IODA_HAS_VARIABLES_INST_TEMPLATE);
