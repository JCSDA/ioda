...
void setupVCPs(pybind11::module& m, pybind11::module& mDetail, pybind11::module& mPy) {
  ...
  py::class_<python_bindings::VariableCreationFillValues<VariableCreationParameters>> sf(mVCP, "setFill");
  sf.doc() = "Set the fill value";
  sf CLASS_TEMPLATE_FUNCTION_PATTERN(setFillValue,
                                     python_bindings::VariableCreationFillValues<VariableCreationParameters>,
  ...
  vcps.def(py::init<>())
    ...
    .def("compressWithSZIP", &VariableCreationParameters::compressWithSZIP,
         "Use SZIP compression (see H5_SZIP_EC_OPTION_MASK in hdf5.h)", py::arg("PixelsPerBlock") = 16,
         py::arg("options") = 4)
