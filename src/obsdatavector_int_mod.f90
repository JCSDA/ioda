...
module obsdatavector_mod
    use, intrinsic :: iso_c_binding, only: &
      c_f_pointer, c_int, c_int64_t, c_null_ptr, c_ptr, c_size_t
    use, intrinsic :: iso_fortran_env, only: int32, int64
    use :: cxx_str_mod, only: cxx_string
    use :: f_c_str_mod, only: c_free, f_string_to_c_dup
    implicit none
    private

    type, public :: obsdatavector_int
    ...
    interface
        function obsdatavector_int_c_get_row_i(p,i) result(r) &
            ...
            type(c_ptr) :: r
        end function obsdatavector_int_c_get_row_i
        function obsdatavector_int_c_get_row_cxx_str(p,s) result(r) &
            ...
            type(c_ptr),value :: s
            type(c_ptr) :: r
        end function obsdatavector_int_c_get_row_cxx_str
        function obsdatavector_int_c_get_row_str(p,s) result(r) &
            ...
            type(c_ptr),value :: s
            type(c_ptr) :: r
        end function obsdatavector_int_c_get_row_str
...
contains
    subroutine obsdatavector_int_init_from_ptr(this,ptr)
        ...
        this%data_ptr = ptr
    end subroutine obsdatavector_int_init_from_ptr
    ...
    end function obsdatavector_int_get_row_i
    function obsdatavector_int_get_row_cxx_str(this,str) result(r)
        ...
        call c_f_pointer(r_ptr,r,[nvars])
    end function obsdatavector_int_get_row_cxx_str
    function obsdatavector_int_get_row_str(this,fstr) result(r)
        ...
        call c_f_pointer(r_ptr,r,[nvars])
    end function obsdatavector_int_get_row_str
